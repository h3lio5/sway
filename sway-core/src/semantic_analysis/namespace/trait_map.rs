...
impl TraitMap {
    ...
    pub(crate) fn insert(
        ...
        let trait_type_id = type_engine.insert(TypeInfo::Custom {
        ...
        } in self.trait_impls.iter()
        {
            ...
            let map_trait_type_id = type_engine.insert(TypeInfo::Custom {
    ...
    pub(crate) fn check_if_trait_constraints_are_satisfied_for_type(
        ...
        let required_traits: BTreeMap<Ident, TypeId> = constraints
            ...
            .map(|c| {
                ...
                let constraint_type_id = type_engine.insert(TypeInfo::Custom {
