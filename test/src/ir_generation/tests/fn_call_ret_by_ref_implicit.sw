...
// check: $(call_a_ret_val=$VAL) = load $call_a_ret_ptr
// check: $(temp_0=$VAL) = get_local ptr { u64, u64, u64 }, $(=__anon_\d+)
// check: store $call_a_ret_val to $temp_0
...
// check: store $call_a_ret_val to $temp_1
...
// check: store $temp_val to $ret_val_arg_ptr
