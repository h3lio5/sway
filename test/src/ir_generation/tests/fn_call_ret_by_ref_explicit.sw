...
// check: $(ret_val=$VAL) = load $ret_val_0

// check: store $ret_val to $(tmp_val=$VAL)
// check: $(idx_val=$VAL) = const u64 1
// check: $(field_val=$VAL) = get_elem_ptr $tmp_val, ptr u64, $idx_val
...
// check: $(ret_val=$VAL) = load $ret_val_1
...
// check: $block_0():
// check: store $VAL to $ret_val_arg
